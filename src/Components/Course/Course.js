                ...
                <div className="card lg:card-side bg-base-100 shadow-xl rounded-2xl">
                    ...
                    <div className="card-body ">
                        ...
                        <div className="card-actions justify-end">
                            ...
                            <button className="btn btn-primary px-8 py-3 mt-6 mb-8 bg-violet-500 custom-bg-font rounded hover:bg-white text-white hover:text-black fond-medium transition duration-300">ENROLL NOW</button>
                        </div>
                    </div>
                </div>
            </div>
